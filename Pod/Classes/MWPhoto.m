...
- (void)_performLoadUnderlyingImageAndNotifyWithWebURL:(NSURL *)url {
    UIImage *cachedImage = [SDImageCache.sharedImageCache imageFromCacheForKey:url.absoluteString];
    if (cachedImage != nil) {
    ...
    @try {
        ...
        _webImageOperation = [downloader downloadImageWithURL:url options:SDWebImageDownloaderHighPriority progress:^(NSInteger receivedSize, NSInteger expectedSize, NSURL * _Nullable targetURL) {
                    if (expectedSize > 0) {
